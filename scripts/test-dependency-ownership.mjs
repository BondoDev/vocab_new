...
test("package manifest direct-dependency total matches the audit's documented total (31)", () => {
  assert.equal(directDepNames.length, 31, `expected 31 direct dependencies, found ${directDepNames.length}`);
});
