-- ============================================================================
-- TIMEZONE PHASE 2 corrective migration - daily-stats conflict targets
-- ============================================================================
--
-- The three no-p_stat_date learning RPCs return an output column named
-- stat_date. In PL/pgSQL, RETURNS TABLE columns are variables, so
-- ON CONFLICT (user_id, target_language, stat_date) is ambiguous inside
-- those functions. Recreate only the three affected primary functions and
-- use the existing named unique constraint instead.
-- ============================================================================
