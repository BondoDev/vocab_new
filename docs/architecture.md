...
flowchart TD
    ...
    VocabData -->|scripts/generate-word-hub-data.mjs| HubData["word-hub-pages/,\nword-browse-shards/,\nverbLists/verbListLookup/"]
...
| SEO metadata | `src/seo/routeMetadataPolicy.ts`, `src/seo/site.ts`, `src/seo/SeoContext.tsx`, `src/data/seo/wordPageData.ts`, `src/seo/metadata.ts` (compatibility facade re-exporting `src/seo/{seoTemplates,seoAlternates,seoFaq,seoSchema,vocabularyMetadata,verbListMetadata,wordMetadata,hubMetadata}.ts`) | rendered `<head>` tags (prerendered + Worker HTML) | `test:seo-output` (chained suite) |
...
| Vocabulary data | `src/data/vocabulary/`, `src/data/vocabularyLevels/`, `src/data/seo/level-browse-preview/`, `src/data/seo/levelTests/`, `src/data/seo/seo-cefr-content.json` | `src/data/seo/word-hub-pages/`, `word-browse-shards/`, `verbLists/verbListLookup/`, `public/vocabularyLevels/*.json` (mirror) | [`docs/generated-data.md`](generated-data.md), `test:generated-data-ownership` |
...
- **Source files** — hand-maintained, committed, edited directly:
  `src/app/`, `src/data/vocabulary/`, `src/data/vocabularyLevels/`,
  `src/data/seo/level-browse-preview/`, `src/data/seo/levelTests/*.json`,
  `src/data/seo/seo-cefr-content.json`, `workers/word-ssr/src/`, `scripts/`.
- **Generated, committed files** — never hand-edited, regenerated by a
  script: `src/data/seo/word-hub-pages/`, `word-browse-shards/`,
  `src/data/seo/verbLists/verbListLookup/`, `public/sitemap.xml` + `public/sitemaps/`,
  `public/vocabularyLevels/*.json` (mirror of `src/data/vocabularyLevels/`).
...
- **Static-route metadata** (`title`, `description`, `canonical`, `robots`)
  ...
  `public-app`, `invalid`).
- **Word-page metadata** — `src/data/seo/wordPageData.ts`, built from the
...
- Hand-maintained sources (no generator; edit directly): `src/data/vocabulary/`,
  `src/data/vocabularyLevels/`, `src/data/seo/level-browse-preview/`,
  `src/data/seo/levelTests/seo_level_test_content.json`,
  `src/data/seo/seo-cefr-content.json`.
- Generated, committed mirrors/output (never hand-edited):
  `src/data/seo/word-hub-pages/`, `word-browse-shards/`,
  `src/data/seo/verbLists/verbListLookup/` (via `npm run generate:word-hub-data`);
