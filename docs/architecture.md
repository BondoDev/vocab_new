...
| Vocabulary data | `src/data/vocabulary/`, `src/data/vocabularyLevels/`, `src/data/seo/level-browse-preview/`, `src/data/levelTests/`, `src/data/seo/seo-cefr-content.json` | `src/data/seo/word-hub-pages/`, `word-browse-shards/`, `verbListLookup/`, `public/vocabularyLevels/*.json` (mirror) | [`docs/generated-data.md`](generated-data.md), `test:generated-data-ownership` |
...
- Generated, committed mirrors/output (never hand-edited):
  ...
  `src/data/verbListLookup/` (via `npm run generate:word-hub-data`);
