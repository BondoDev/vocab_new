...
| Vocabulary data | `src/data/vocabulary/`, `src/data/vocabularyLevels/`, `src/data/seo/level-browse-preview/`, `src/data/levelTests/`, `src/data/seo/seo-cefr-content.json` | `src/data/seo/word-hub-pages/`, `word-browse-shards/`, `verbLists/verbListLookup/`, `public/vocabularyLevels/*.json` (mirror) | [`docs/generated-data.md`](generated-data.md), `test:generated-data-ownership` |
...
- **Source files** — hand-maintained, committed, edited directly:
  ...
  `src/data/seo/level-browse-preview/`, `src/data/levelTests/*.json`,
