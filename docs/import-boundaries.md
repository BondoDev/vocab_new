...
| `scripts/generate-sitemap.mjs` (`collectLevelTestRoutes`) | `fs.readFile` | `src/data/levelTests/seo_level_test_content.json` | build-time generator | low |
| `src/data/levelTests/index.ts` | static relative `import` | `./seo_level_test_content.json` | client + SSR | low |
