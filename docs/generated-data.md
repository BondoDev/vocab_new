...
| `src/data/seo/verbLists/common100Verbs/verbListLookup/` | generated committed source | `verbLists/shared/list_of_100_most_used_verb.json` + vocabulary.json | `scripts/generation/generate-word-hub-data.mjs` | client + SSR (`common100VerbList.ts`, eager glob G6); not the Worker | yes | low |
