...
| `src/data/verbLists/verbListLookup/` | generated committed source | `list_of_100_most_used_verb.json` + vocabulary.json | `scripts/generate-word-hub-data.mjs` | client + SSR (`commonVerbList.ts`, eager glob G6); not the Worker | yes | low |
...
| Directory | Command |
|---|---|
| `src/data/seo/word-hub-pages/`, `src/data/seo/word-browse-shards/`, `src/data/verbLists/verbListLookup/` | `npm run generate:word-hub-data` |
...
- **Not allowed — will be overwritten:** `src/data/seo/word-hub-pages/`,
  `src/data/seo/word-browse-shards/`, `src/data/verbLists/verbListLookup/`,
