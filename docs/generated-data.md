...
| `src/data/seo/verbLists/conjugated100Verbs/conjucated100VerbsList.json` | handwritten source | itself | manual (no generator) | `conjugated100VerbFormsData.ts`, transitively `ConjugatedVerbFormsTableSection.tsx` | yes | medium — tense-grouped 100-verb conjugation rows; additional tense entries can be added to the same array |
